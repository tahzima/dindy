    ...
    <div class="container mt-4">
      ...
      <div class="row col-md-12 col-md-offset-2 custyle">
        <table class="table">
          ...
          <tbody>
          <?php foreach($allCommande as $row){ ?>
            <tr>
                <td>
                ...
                <td>
                  <label><?=$row['prix']?></label>
                </td>
                <td>
                  <label><?=$row['prixTT']?></label>
                </td>
                <td>
                  <label><?=$row['numFacture']?></label>
                </td>
                <td class="text-center">
                  <a href="http://localhost/gestionEmplois/reservation//"  class="btn btn-info">Edite</a> 
                  <a href="http://localhost/gestionEmplois/reservation/delete/" class="btn btn-danger">Delete</a>
                </td>
            </tr>
            <?php } ?>
          </tbody>
